...
if (isFavorite === true) {
  console.log(`My favotite food is ${food}!`);
} else {
...
var vegetables = ["broccoli", "carrot", "potato", "onion", "garlic"];
...
var fruits = ["apple", "banana", "kiwi", "peach", "pineapple", "guava", "papaya"];
